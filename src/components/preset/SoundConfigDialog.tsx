...
import { SoundConfig } from '../../types/preset';
...
interface Props {
  visible: boolean;
  onClose: () => void;
  onSave: (soundConfigs: SoundConfig[]) => void;
  phase: { name: string; soundConfigs: SoundConfig[] };
}
        ...
        <View style={{ backgroundColor: c.surface, borderRadius: 16, padding: 20, maxHeight: '85%' }}>
          ...
          <ScrollView>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
              <Text style={{ fontSize: 14, fontWeight: '600', color: c.onBackground }}>Sounds</Text>
              <Pressable
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'flex-end', gap: 12, marginTop: 16 }}>
            ...
            <Pressable
              onPress={() => { onSave(intervalSounds); onClose(); }}
